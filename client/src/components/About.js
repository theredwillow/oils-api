      ...
      <div className="aboutwrapper">
        ...
        <div className="about" id="about">
          <div className="profile">
            ...
            <h2 className="likes">
              Likes: tarot, long hikes, early mornings, rosemary, peonies & her
              cat Tallulah
            </h2>
            <h2 className="likes">
          ...
          <div className="profile">
            ...
            <h2 className="likes">
              Likes: local coffee, mountain biking, her DSLR camera, late nights
              & her dog Lana
            </h2>
            <h2 className="likes">
              Dislikes: gum chewing, last minute changes, shopping malls &
              inequality
            </h2>
          </div>
        </div>
        ...
        <h2 className="reach">
          ...
          <a href="mailto:hello@myblendology.com">hello@myblendology.com</a> or
          check out our instagram page today.
        </h2>
      </div>
    );
  }
