...
class App extends Component {
  ...
  updateBlends() {
    if (this.state.isLoggedIn) {
      Axios.get("/api/blend/user").then(({ data }) => {
        console.log("done");
        console.log(data);
        this.setState(
          {
    ...
    return (
      <div>
        <Navbar
          ...
          updateBlends={this.updateBlends.bind(this)}
            ...
            render={() => {
              return (
                <User
                  ...
                  currentLevel={this.state.user.blends}
                  isLoggedIn={this.state.isLoggedIn}
                  updateBlends={this.updateBlends}
                />
              );
            }}
          />
