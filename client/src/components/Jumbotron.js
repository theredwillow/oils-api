      ...
      <div>
        <div className="container-fluid msg-container">
          <div className="headline">
            ...
            <div className="row flex-row justify-content-center info">
              <div className="main-col">
                ...
                <span className="info-blurb">
                  Pick a mood and follow the descriptions of each oil to guide
                  you.
                </span>
              </div>
              <div className="main-col">
                <img
                  className="icon"
                  src="./img/fingerprint2.png"
                  alt="createIcon"
                  height="40"
                />
                <span className="info-header">Create</span>
                <span className="info-blurb">
                  After your selection, we will provide you the exact
              ...
              <div className="main-col">
                ...
                <span className="info-blurb">
                  Sit back, relax, and enjoy a blend as unique as you are.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="row flex-row justify-content-center buttons">
            <button
              href="#"
              onClick={this.props.handleMoodClick}
